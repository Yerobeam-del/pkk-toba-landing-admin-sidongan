{{-- ============================================================
     ...
     Reset Password (Admin Panel) — layout split-panel ob-*,
    ...
    <div class="ob-split">
        ...
        <div class="ob-left">
            <div class="ob-left-content">
                ...
                <p class="ob-subtitle">Anda sedang mengganti password akun Admin Panel. Buat password yang kuat dan mudah Anda ingat.</p>
        ...
        <div class="ob-right">
            <div class="ob-right-content">
                ...
                <form method="POST" action="{{ route('password.store') }}" class="ob-form" data-validate>
                    @csrf
