...
<meta charset="UTF-8">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap" rel="stylesheet">
        ...
        <link rel="stylesheet" href="{{ asset('assets/auth/css/auth-reset-password.css') }}">
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        ...
                        >
                        <button type="button" class="toggle-password" data-toggle-password="password" tabindex="-1">
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        ...
                        >
                        <button type="button" class="toggle-password" data-toggle-password="password_confirmation" tabindex="-1">
