...
@section('content')
    <link rel="stylesheet" href="{{ asset('assets/admin/css/admin-template-index.css') }}">


{{-- Header Section --}}
<div class="template-header u-a12">
    <div class="u-flex-1-min">
        <h1 class="u-page-title-tight">Template PKK</h1>
        <p class="u-muted">Kelola template dokumen resmi PKK</p>
    </div>
    <a href="{{ route('admin.template.create') }}" class="btn btn-primary u-inline-flex-gap-2-nowrap">
...
<div class="stats-grid u-a4">
    <div class="stat-card u-badge-blue">
        <div class="u-flex-start-gap-4">
            ...
            <div class="u-flex-1">
                <p class="u-subtitle">Total Template</p>
...
<div class="u-header-row-wrap">
    {{-- Search Form --}}
    <div class="template-search-wrapper u-flex-1-min-200">
        <form method="GET" action="{{ route('admin.template.index') }}">
            ...
            <div class="u-relative">
                ...
                <input type="text" name="search" value="{{ request('search') }}" class="template-search-input u-input-icon-left" placeholder="Cari template...">
                @if(request('search'))
    ...
    {{-- Per Page Dropdown --}}
    <div class="template-perpage-wrapper u-flex-center-gap-2-shrink">
        <form method="GET" action="{{ route('admin.template.index') }}" class="template-form-wrapper u-flex-center-gap-2">
            <input type="hidden" name="tab" value="{{ $currentTab }}">
...
<div class="card u-a11">
    ...
    <script src="{{ asset('assets/admin/js/admin-template-index.js') }}"></script>
