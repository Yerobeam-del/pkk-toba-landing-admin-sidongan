    ...
    <div class="u-p-0">
        ...
        @include('admin.partials.table', [
            ...
            'rowActions' => function ($item) use ($module, $config, $rowLabel) {
                ...
                $name = $rowLabel($item);
                $styleBtn = 'width:32px;height:32px;display:inline-flex;align-items:center;justify-content:center;background:transparent;color:var(--text-muted);border-radius:6px;transition:all 0.2s;cursor:pointer;border:none';
                $styleBtnOver = 'this.style.background=\'var(--bg-hover,rgba(20,184,166,0.1))\';this.style.color=\'var(--primary)\'';
                $styleBtnOut = 'this.style.background=\'transparent\';this.style.color=\'var(--text-muted)\'';

                $html = '<a href="' . route('admin.sieda-data.show', [$module, $id]) . '" title="Lihat Detail" aria-label="Lihat detail ' . addslashes($name) . '" style="' . $styleBtn . '">'
                ...
                $html .= '<button type="button" data-delete-item="' . $id . '" data-delete-title="' . addslashes($name) . '" title="Hapus Permanen" aria-label="Hapus permanen ' . addslashes($name) . '" style="' . $styleBtn . ';border:none">'
...
<div class="sieda-danger-zone" style="margin-top:1.5rem; border:1px solid rgba(239,68,68,0.2); border-left:4px solid #dc2626; background:#fef2f2; padding:1.25rem 1.5rem; border-radius:12px">
    <div style="display:flex; justify-content:space-between; align-items:center; gap:1rem; flex-wrap:wrap">
        ...
        <form method="POST" action="{{ route('admin.sieda-data.delete-all', $module) }}" class="delete-all-form"
            ...
            <button type="submit" class="sieda-danger-btn" style="background:linear-gradient(135deg,#ef4444,#b91c1c);color:#fff;border:none;border-radius:8px;padding:0.6rem 1.25rem;display:inline-flex;align-items:center;gap:0.5rem;font-weight:600;font-size:0.875rem;cursor:pointer;transition:all 0.2s">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/>
                </svg>
                Hapus Semua Data
