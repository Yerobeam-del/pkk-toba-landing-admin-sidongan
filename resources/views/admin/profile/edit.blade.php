...
<div class="u-header-row-plain">
    <div>
        <h1 class="u-page-title">Edit Profil</h1>
        <p class="u-muted">Kelola informasi akun dan akses aplikasi Anda</p>
    </div>
    @if (session('sso_from_sieda'))
    {{-- Diakses dari SIEDA: tombol Kembali diganti menjadi Kembali ke SIEDA --}}
    <a href="{{ $ssoBackUrl }}" class="btn btn-primary btn-back-sieda">
