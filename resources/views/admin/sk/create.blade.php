...
@section('content')
    <link rel="stylesheet" href="{{ asset('assets/admin/css/admin-sk-create.css') }}">


{{-- Header --}}
<div class="sk-header u-header-row">
    <div class="u-flex-1-min">
        <h1 class="u-page-title">Tambah Dokumen</h1>
        <p class="u-muted">Unggah SK atau dokumen baru untuk dikelola</p>
    </div>
...
<div class="card">
    ...
    <script src="{{ asset('assets/admin/js/admin-sk-create.js') }}"></script>
