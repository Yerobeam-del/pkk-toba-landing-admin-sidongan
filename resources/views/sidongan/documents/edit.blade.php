...
<div class="sd-page u-px-6">
    ...
    <form action="{{ route('sidongan.documents.update', $document) }}" method="POST" enctype="multipart/form-data" id="editForm">
        ...
        <div class="animate-slide-in u-card-white">
            {{-- Form Header --}}
            <div class="sd-form-info-header">
                <h2 class="sd-form-info-title">
            ...
            <div class="u-p-6">
                <div class="sd-edit-grid">
                    ...
                    <div class="sd-edit-col">
                        <h3 class="sd-section-title-edit">
                    ...
                    <div class="sd-edit-col">
                        ...
                        <div>
                            ...
                            <input type="text" id="preview_agenda_edit" value="{{ $document->agenda_number ?? 'Belum ada' }}" readonly class="sd-agenda-input-edit">
                            <input type="hidden" name="agenda_number" id="agenda_number_edit_input" value="{{ $document->agenda_number ?? '' }}">
                            <p class="sd-agenda-hint">Klik dua kali untuk mengubah nomor agenda</p>
                        </div>
                        <div>
                            ...
                            <small class="sd-agenda-hint">Tanggal surat diterima di Sekretariat</small>
                            @error('agenda_date')
                                <div class="u-inline-alert-danger">
                                    <i class="fas fa-exclamation-circle u-error-msg"></i>
                                    <span class="u-text-danger-soft">{{ $message }}</span>
                ...
                <div class="sd-file-section">
                    ...
                    <div class="u-relative">
                        ...
                        <div id="dropZone" class="sd-dropzone-edit">
                            <div id="uploadPlaceholder">
                                <i class="fas fa-cloud-upload-alt sd-dropzone-edit-icon"></i>
                                <p class="sd-dropzone-edit-text">Klik untuk memilih file atau seret file ke sini</p>
                                <p class="u-text-xs-muted-flat2">PDF, JPG, PNG, DOC, DOCX (Maks. 5MB)</p>
                            </div>
                            <div id="filePreview" class="sd-file-preview-edit">
                                <div class="sd-file-preview-edit-card">
                                    <div class="u-flex-center-gap-3">
                                        <div id="fileIcon" class="sd-file-icon-sm">
                                            <i class="fas fa-file-pdf u-text-danger-lg"></i>
                                        </div>
                                        <div class="u-a87">
                                            <p id="fileName" class="sd-file-name-edit">nama_file.pdf</p>
                                            <p id="fileSize" class="sd-file-size-edit">0 KB</p>
                                        </div>
                                        <span class="sd-file-badge-edit">
                                            <i class="fas fa-check" style="margin-right: 0.2rem; font-size: 0.6rem;"></i> Siap
                                        </span>
                                    </div>
                                </div>
                                <button type="button" data-action="change-file" class="sd-file-change-btn">
