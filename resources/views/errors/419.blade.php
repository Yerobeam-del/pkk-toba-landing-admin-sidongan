...
<head>
    ...
    <title>419 - Page Expired</title>
        <link rel="stylesheet" href="{{ asset('assets/shared/css/errors-419.css') }}">
...
<body>
    ...
    <div class="container">
        ...
        <button data-error-action="reload" class="btn">
        ...
        <script src="{{ asset('assets/shared/js/errors-419.js') }}"></script>
</body>
</html>
{{-- Dikembangkan oleh Institut Teknologi Del --}}
