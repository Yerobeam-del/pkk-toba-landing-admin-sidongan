<section class="quick-access-section" id="quickAccess">
    ...
    <div class="quick-access-grid">
        <a href="#struktur" onclick="navigateTo('struktur'); return false;" class="quick-access-card">
        ...
        <a href="#aplikasi" onclick="navigateTo('aplikasi'); return false;" class="quick-access-card">
        ...
        <a href="#berita" onclick="navigateTo('berita'); return false;" class="quick-access-card">
        ...
        <a href="#sk" onclick="navigateTo('sk'); return false;" class="quick-access-card">
        ...
        <a href="#template" onclick="navigateTo('template'); return false;" class="quick-access-card">
            <div class="quick-access-icon" style="background: linear-gradient(135deg, #2b6cb0, #3182ce);">
