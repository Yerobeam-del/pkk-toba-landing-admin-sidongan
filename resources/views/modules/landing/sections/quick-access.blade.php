...
<section class="quick-access-section" id="quickAccess">
    <div class="section-header">
        ...
        @once
    @push('styles')
    <link rel="stylesheet" href="{{ asset('assets/landing/css/modules-landing-sections-quick-access.css') }}">
    @endpush
    @endonce


    <div class="quick-access-grid">
        <a href="#struktur" data-nav="struktur" class="quick-access-card">
        ...
        <a href="#aplikasi" data-nav="aplikasi" class="quick-access-card">
        ...
        <a href="#berita" data-nav="berita" class="quick-access-card">
        ...
        <a href="#template" data-nav="template" class="quick-access-card">
            <div class="quick-access-icon" style="background: linear-gradient(135deg, #2b6cb0, #3182ce);">
