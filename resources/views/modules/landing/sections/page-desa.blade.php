...
<div class="page" id="page-desa">
    ...
    <section class="desa-section">
        ...
        {{-- Toolbar: Pencarian + Filter Kecamatan (filter diisi otomatis oleh JS) --}}
        <div class="desa-toolbar u-hidden" id="desaToolbar">
            <div class="desa-search">
                <svg class="desa-search-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
                <input type="text" id="desaSearch" placeholder="Cari nama desa atau kecamatan..." autocomplete="off" aria-label="Cari desa">
            </div>
